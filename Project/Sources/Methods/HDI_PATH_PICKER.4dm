...
Case of 
	...
	: (Length:C16($Txt_entryPoint)=0)
		...
		Case of 
			...
			Else 
				...
				BRING TO FRONT:C326(New process:C317($Txt_methodName;24*1024;"$"+$Txt_methodName;"_run";*))
	...
	: ($Txt_entryPoint="_init")
		...
		SET MENU ITEM PROPERTY:C973($Mnu_edit;-1;Associated standard action:K56:1;_o_Undo action:K59:16)
		...
		SET MENU ITEM PROPERTY:C973($Mnu_edit;-1;Associated standard action:K56:1;_o_Redo action:K59:17)
		...
		SET MENU ITEM PROPERTY:C973($Mnu_edit;-1;Associated standard action:K56:1;_o_Cut action:K59:18)
		...
		SET MENU ITEM PROPERTY:C973($Mnu_edit;-1;Associated standard action:K56:1;_o_Copy action:K59:19)
		...
		SET MENU ITEM PROPERTY:C973($Mnu_edit;-1;Associated standard action:K56:1;_o_Paste action:K59:20)
		...
		SET MENU ITEM PROPERTY:C973($Mnu_edit;-1;Associated standard action:K56:1;_o_Clear action:K59:21)
		
		APPEND MENU ITEM:C411($Mnu_edit;Get localized string:C991("CommonMenuItemSelectAll"))
		SET MENU ITEM PROPERTY:C973($Mnu_edit;-1;Associated standard action:K56:1;_o_Select all action:K59:22)
		...
		SET MENU ITEM PROPERTY:C973($Mnu_edit;-1;Associated standard action:K56:1;_o_Show clipboard action:K59:23)
